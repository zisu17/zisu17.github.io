...
[PSQL WAL 관련 문서](https://www.postgresql.org/docs/current/wal-intro.html)
...
[PSQL WAL Config 관련 문서](https://www.postgresql.org/docs/current/runtime-config-wal.html)
...
- **wal_sync_method**: WAL 데이터를 디스크에 동기화하는 방법 설정. 일반적으로 `fdatasync`가 기본값
